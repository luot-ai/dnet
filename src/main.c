...
// void print_matrix(const char* name, const float* matrix, TensorDim dim) {
//     printf("%s:\n", name);
//     int rows=dim.h;
//     int cols=dim.w;
//     int channels=dim.c;
...
int main() {
  ...
  //print_matrix("Col Matrix", col_matrix, col_dim);
  ...
  int GM = M;
  int GN = colW ; // Adjust N based on your requirement
